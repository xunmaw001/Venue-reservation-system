<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="球馆名称" prop="qiuguanmingcheng">
          <el-input v-model="ruleForm.qiuguanmingcheng" 
              placeholder="球馆名称" clearable  :readonly="ro.qiuguanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="球馆名称" prop="qiuguanmingcheng">
              <el-input v-model="ruleForm.qiuguanmingcheng" 
                placeholder="球馆名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="场地数量" prop="changdishuliang">
          <el-input v-model="ruleForm.changdishuliang" 
              placeholder="场地数量" clearable  :readonly="ro.changdishuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="场地数量" prop="changdishuliang">
              <el-input v-model="ruleForm.changdishuliang" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="球馆介绍" prop="qiuguanjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.qiuguanjieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qiuguanjieshao" label="球馆介绍" prop="qiuguanjieshao">
                    <span v-html="ruleForm.qiuguanjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.qiuguanjieshao = this.ruleForm.qiuguanjieshao.replace(reg,'../../../ssmv69yq/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `qiuguanxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.qiuguanxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
